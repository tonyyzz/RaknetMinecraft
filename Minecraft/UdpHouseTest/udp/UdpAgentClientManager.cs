...
namespace UdpHouseTest
{
	...
	/// 向udp代理服务器发送消息
	/// </summary>
	class UdpAgentClientManager
	{
		public static UdpAgentClientManager Instance = null;

		private string IpAddress = "";
		private int Port = 0;

		private System.Net.Sockets.UdpClient client = null;
		public static UdpAgentClientManager InitInstance(string ipAddress, int Port, Action<Model.PlayerModel> func = null, Model.PlayerModel player = null)
		{

			if (Instance == null)
			{

				Instance = new UdpAgentClientManager()
				{
					IpAddress = ipAddress,
					Port = Port,
